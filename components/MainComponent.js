...
const ContactNavigator = createStackNavigator(
    ...
    },
    {
        navigationOptions: ({navigation}) => ({
            ...
            headerLeft: <Icon name='address-card' type='font-awesome' iconStyle={styles.stackIcon}
            onPress={() => navigation.toggleDrawer()} />
        })
    }
);
...
class Main extends Component {
    ...
    componentDidMount() {
        ...
        NetInfo.fetch().then(connectionInfo => {
            ...
            : ToastAndroid.show("Initial Network Connectivity Type: " + connections.type, ToastAndroid.LONG);
        });
